...
this.canvasTopologyNavigation = new NxtControl.GuiFramework.CanvasTopologyRose();
      ...
      this.workArea.Size = new System.Drawing.Size(1024, 688);
    ...
    this.siblingsPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(0)), ((float)(665)), ((float)(80)));
    ...
    this.childrenPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(39)), ((float)(665)), ((float)(80)));
    ...
    // 
      ...
      this.canvasTopologyNavigation.Bounds = new NxtControl.Drawing.RectF(((float)(119)), ((float)(0)), ((float)(80)), ((float)(80)));
      ...
      this.canvasTopologyNavigation.TransformMatrix = new NxtControl.Drawing.Matrix2D(0.879120879120879, 0, 0, 0.919540229885057, 111.967032967033, -1.83908045977011);
